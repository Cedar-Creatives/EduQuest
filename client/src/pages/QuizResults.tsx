      ...
      {wrongAnswers.length > 0 && (
        <Card className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-0 shadow-lg border-l-4 border-l-red-500">
          ...
          <CardContent>
            <div className="space-y-4">
              {wrongAnswers.map((answer, index) => (
                <div key={index} className="p-4 rounded-lg bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/20">
                  <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2">{answer.question}</h4>
                  
                  <div className="mb-3">
                    <div className="text-sm text-red-700 dark:text-red-300 mb-1 flex items-center">
                  ...
                  {answer.explanation && (
                    <div className="mt-2 text-sm bg-blue-50 dark:bg-blue-900/10 p-3 rounded border border-blue-100 dark:border-blue-900/20">
                      <span className="font-medium text-blue-700 dark:text-blue-300">Explanation:</span>
                      <p className="text-gray-700 dark:text-gray-300 mt-1">{answer.explanation}</p>
                    </div>
                  )}
                </div>
              ))}
